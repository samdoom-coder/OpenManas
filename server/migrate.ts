...
async function main() {
  ...
  const files = ['001_initial.sql', '002_db_performance.sql', '002_page_theme.sql', '003_derived.sql', '005_db_favorite.sql', '006_share_links.sql', '007_collab_indexes.sql', '008_activities_target_text.sql', '009_page_versions_message.sql', '010_cover_position.sql']
  try {
